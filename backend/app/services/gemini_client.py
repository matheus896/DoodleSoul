...
def build_agent_instruction(*, native_tools_enabled: bool, persona_data: dict | None = None) -> str:
    ...
    clinical_block = (
        ...
        "- trigger: What caused it (e.g. fight at school). Leave empty for positive states.\n"
        "- recommended_strategy: What you will do to comfort or engage the child.\n"
        "- risk_level: \"none\" for positive/neutral states; \"low\", \"medium\", or \"high\" for concerning ones.\n"
